...
export class ReservationService {
  ...
  getRoomIdsByReservationId(reservationId: number): Observable<number[]> {
    return this.http.get<number[]>("http://localhost:8081/api/reservation/rooms" + `/${reservationId}`, { headers: this.getHeaders() });
  }
